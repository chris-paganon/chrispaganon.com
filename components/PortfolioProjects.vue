...
.view-more-overlay {
  ...
  background-image: -webkit-linear-gradient(to top, rgb(255, 251, 246), transparent); /* Chrome10+,Safari5.1+ */
  background-image: -o-linear-gradient(to top, rgb(255, 251, 246), transparent); /* Opera 11.10+ */
